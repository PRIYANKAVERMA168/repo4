/*const lightbox = document.getElementryByID('lightbox');
const galleryItems = document.querySelectorAll('.imageContainer img');
const closeBtn__img = document.getElementById('lightboxImg');
...
galleryItems.forEach((Image, index) => {
    galleryItems[index].addEventListener('click', () => openLightbox
    (index));
});
